...
import { ScoreResponse } from '../adapter/Adapter';
import { Dispatch } from 'redux';
import { CanvasScreen } from '../utils/CanvasScreens';

interface InstructionsProps extends ScreenProps {
...
class Instructions extends React.PureComponent<InstructionsProps, InstructionsState> {
  public constructor(props: InstructionsProps) {
    super(props);
    this.state = {
      topScores: null
    };
