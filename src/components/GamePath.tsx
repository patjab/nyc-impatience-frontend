...
import { horizonLine, canvasWidth, canvasHeight, brickColor, brickBorderColor, numOfBricksInARow, depthMultiplier, movementPerBrick, brickSpacingBetweenRows, touristDensity, heightOfMap } from '../setupData';
